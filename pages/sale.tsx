...
const Sale = () => {
	...
	return (
		<Layout>
			...
			<section className='pt-100-60 pos ' style={ style }>
				...
				natus, possimus! Ad commodi doloremque ipsum, maiores maxime officiis recusandae repellat saepe totam veritatis
				voluptas voluptatum. Accusantium enim et expedita iure labore, natus neque nisi, numquam obcaecati perferendis
				praesentium, quae quam quibusdam recusandae rerum sed suscipit? Aperiam commodi cupiditate ducimus ea eum fugiat
				id ipsum magni maiores maxime, molestiae odio possimus qui tempore voluptatum. Aspernatur inventore nulla quasi
